...
#### Product Engineer @ Imperial College London                                                                                               2020 2021
...
- Improved change plans, system testing, maintenance changes / upgrades and coordination of user acceptance testing 
- Build up relationships for day-to-day delivery, support and issues with internal teams and 3rd party suppliers 

#### Application Support Analyst @ Informa                                                                                                   2019 - 2020

- Liaised with marketing and technical teams at all levels across EMEA, Middle East, US and Brazil whilst maintaining productions system used for campaigns across multiple social media advertising programs
- Represented Level 2 technical support for Global Exhibitions’ enterprise applications when liaising with Marketing and Sales teams utilizing Eloqua, Adobe Analytics, AEM and cloud technology
- Management and resolution of Incidents and Service Requests within agreed SLA’s

#### Application Support Analyst @ Application Support Analyst @ Wonga                                                                       2016 - 2019
 
- Cultivated DevOps culture by interacting with all areas of the business providing technical insight with a strong customer focus for multinational teams based in UK. Poland, South Africa and Spain. 
- Acted as a Scrum Master for the Application Support team
- Shaped out post-mortem procedures following major systems outages and communicating follow-up actions to the relevant teams leading to Root Cause Analysis and system improvements via Problem Management
- Conducted knowledge sharing sessions to the new Analysts on boarded to the team

#### Technical Support Analyst @ FircoSoft                                                                                                   2015 - 2016

- Improved the support process and communication between remote members of the team 
- Assisted Professional Services Consultants with technical questions during project implementation 
- Identified and escalated crucial bugs and completed root cause analysis of defects 
- Installed and configured customer specific environments for troubleshooting and resolving application issues escalated from end users 

#### Jive Software (Oct 2011 - Sept 2015)

- Uplifted quality of customer service through refinement of procedures and protocols:
- Authored a variety of technical documents that facilitated effective troubleshooting and provisioning.
- Designed and delivered induction and training programme that rapidly progressed newcomers to valuable team members.
- Commended by management for smooth transition of responsibilities from UK Hosting team. Singlehandedly ran team for 6 months.
...
I am currently mentoring a Junior Programmer who just finished Makers course.
